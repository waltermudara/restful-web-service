...
@ControllerAdvice
@RestController
public class CustomisedExceptionResponseHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleUserNotFoundException(CustomUserNotFoundException ex, WebRequest request) throws Exception {
